...
<div class="flex flex-col items-center justify-center p-8">
    <div class="bg-white mt-10 p-8 w-full h-full rounded-md">
        <p class="font-sans text-2xl font-medium text-gray-600">Domínios</p>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($domains as $d)
                                <tr>
                                    ...
                                    <td class="px-6 py-3 text-sm p-3 border-t border-grey-light whitespace-no-wrap">
                                        {{ \Carbon\Carbon::parse($d->expiration_date )->format('d/m/Y') }}
                                    </td>

                                    <td class="flex flex-row align-center gap-2 justify-center mt-2">
                                        <a href="{{ route('domains.show', $d->id) }}">
                                            <button>
                                        ...
                                        <form name="frDelete" action="{{ route('domains.destroy', $d->id)}}" method="POST">
